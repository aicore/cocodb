...
export async function put(request) {
    ...
    if (!validate(COCO_DB_FUNCTIONS.put, request, VALIDATE.REQUEST)) {
    ...
    try {
        ...
        if (!validate(COCO_DB_FUNCTIONS.put, response, VALIDATE.RESPONSE_SUCCESS)) {
        ...
        if (!validate(COCO_DB_FUNCTIONS.put, response, VALIDATE.RESPONSE_FAIL)) {
